<?php
/*
 * Load pre-domain texts
 *
 * If there are not strings in your language yet, please send them me at: alo@eventualo.net
 */
 
global $alo_em_textpre;
$alo_em_textpre = array();
...
$alo_em_textpre['alo_em_txtpre_activationmail_subj']['ca'] = "Confirmi la seva subscripció a la llista de correu de %BLOGNAME%";
$alo_em_textpre['alo_em_txtpre_activationmail_subj']['cs'] = "Potvrďte odběr novinek z %BLOGNAME%";
$alo_em_textpre['alo_em_txtpre_activationmail_subj']['da'] = "Bekræft dit abonnement på %BLOGNAME% nyhedsbrev";
...
$alo_em_textpre['alo_em_txtpre_activationmail_subj']['et'] = "Kinnita oma liitumist %BLOGNAME% uudiskirjaga";
...
$alo_em_textpre['alo_em_txtpre_activationmail_mail']['en'] = "Hi %NAME%,
...
$alo_em_textpre['alo_em_txtpre_activationmail_mail']['br'] = "Olá %NAME%,
...
$alo_em_textpre['alo_em_txtpre_activationmail_mail']['ca'] = "Hola %NAME%,
...
$alo_em_textpre['alo_em_txtpre_activationmail_mail']['cs'] = "Ahoj %NAME%,
...
$alo_em_textpre['alo_em_txtpre_activationmail_mail']['el'] = "Γεια %NAME%,
...
$alo_em_textpre['alo_em_txtpre_activationmail_mail']['es'] = "Hola %NAME%,
...
$alo_em_textpre['alo_em_txtpre_activationmail_mail']['et'] = "Tere, %NAME%,
...
$alo_em_textpre['alo_em_txtpre_activationmail_mail']['fa'] = "سلام %EMAN%
برای کامل شدن روند اشتراک شما به خبرنامه %EMANGOLB% بایستی بر روی پیوند آمده کلیک کنید (یا در محل آدرس‌بار مرورگرتان پیست کنید):
...
$alo_em_textpre['alo_em_txtpre_activationmail_mail']['fi'] = "Tervehdys %NAME%,
...
$alo_em_textpre['alo_em_txtpre_activationmail_mail']['fr'] = "Bonjour %NAME%,
...
$alo_em_textpre['alo_em_txtpre_activationmail_mail']['it'] = "Salve %NAME%,
...
$alo_em_textpre['alo_em_txtpre_activationmail_mail']['nl'] = "Beste %NAME%,
...
$alo_em_textpre['alo_em_txtpre_activationmail_mail']['pl'] = "Witaj %NAME%,
...
$alo_em_textpre['alo_em_txtpre_activationmail_mail']['tr'] = "Merhaba %NAME%
...
$alo_em_textpre['alo_em_custom_unsub_footer']['ca'] = "<p><em>Ha rebut aquest missatge perquè està subscrit/a a la nostra llista de correu. Si vol eliminar la seva subscripció, cliqui en aquest enllaç<br /> %UNSUBSCRIBELINK%</em></p>";
$alo_em_textpre['alo_em_custom_unsub_footer']['cs'] = "<p><em>Tato zpráva Vám přišla, protože jste se přihlásil/a k odběru našeho newsletteru. Pokud se chcete odhlásit navštívit odkaz<br /> %UNSUBSCRIBELINK%</em></p>";
...
$alo_em_textpre['alo_em_custom_unsub_footer']['et'] = "<p><em>Selle kirja saite vastusena liitumisele meie uudikirja postiloendiga. Kui te soovite loobuda uudiskirjast: külasta seda linki<br /> %UNSUBSCRIBELINK%</em></p>";
...
/*
 * Read newsletter online Discalimer
 *----------------------------------*/
...
$alo_em_textpre['alo_em_custom_viewonline_msg']['ca'] = "<p><em>Per a llegir la notícia online cliqui en aquest enllaç: %NEWSLETTERLINK%</em></p>";
$alo_em_textpre['alo_em_custom_viewonline_msg']['cs'] = "<p><em>Pro přečtění newsletteru online můžete navšívit tento odkaz: %NEWSLETTERLINK%</em></p>";
...
$alo_em_textpre['alo_em_custom_viewonline_msg']['et'] = "<p><em>Selle lingi abil saad lugeda uudiskirja veebis: %NEWSLETTERLINK%</em></p>";
